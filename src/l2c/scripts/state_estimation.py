...
class FrankaEEFInfoNode:
    def __init__(self):
        ...
        self.robot_model = pin.buildModelFromUrdf(os.path.join(os.path.dirname(os.path.abspath(__file__)),'../robots/panda.urdf'))
        self.robot_data = self.robot_model.createData()

        self._ee_frame = self.robot_model.getFrameId('panda_hand_tcp') #TODO add to config
    ...
    def joint_state_callback(self, msg):
        ...
        pin.updateFramePlacement(self.robot_model, self.robot_data, self._ee_frame)
        ...
        eef_pose = self.robot_data.oMf[self._ee_frame]
